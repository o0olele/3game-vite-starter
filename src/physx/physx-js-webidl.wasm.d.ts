...
declare module PhysX {
    ...
    class NativeArrayHelpers {
        ...
        static setU8At(base: unknown, index: number, value: number): void;
        static setU16At(base: unknown, index: number, value: number): void;
        static setU32At(base: unknown, index: number, value: number): void;
        static setRealAt(base: unknown, index: number, value: number): void;
        ...
        static getDebugPointAt(base: PxDebugPoint, index: number): PxDebugPoint;
        static getDebugLineAt(base: PxDebugLine, index: number): PxDebugLine;
        static getDebugTriangleAt(base: PxDebugTriangle, index: number): PxDebugTriangle;
    ...
    class PxArticulationReducedCoordinate extends PxBase {
        ...
        createSensor(link: PxArticulationLink, relativePose: PxTransform): PxArticulationSensor;
    ...
    class PxArticulationSensor extends PxBase {
        getForces(): PxSpatialForce;
        getRelativePose(): PxTransform;
        setRelativePose(pose: PxTransform): void;
        getLink(): PxArticulationLink;
        getIndex(): number;
        getArticulation(): PxArticulationReducedCoordinate;
        getFlags(): PxArticulationSensorFlags;
        setFlag(flag: PxArticulationSensorFlagEnum, enabled: boolean): void;
        userData: unknown;
    }
    class PxArticulationSensorFlags {
        constructor(flags: number);
        isSet(flag: PxArticulationSensorFlagEnum): boolean;
        raise(flag: PxArticulationSensorFlagEnum): void;
        clear(flag: PxArticulationSensorFlagEnum): void;
    }
    ...
    class PxScene extends PxSceneSQSystem {
        ...
        addFromCollection(collection: PxCollection, id: number): PxActor;
    ...
    class PxSerialization {
        ...
        static createCollectionFromBinXml(memBlock: unknown, length: number, params: PxCookingParams, sr: PxSerializationRegistry, externalRefs?: PxCollection): PxCollection;
    ...
    enum EngineDriveVehicleEnum {
        'DIFFTYPE_FOURWHEELDRIVE',
        'DIFFTYPE_MULTIWHEELDRIVE',
        'DIFFTYPE_TANKDRIVE'
    }
    ...
    enum PxArticulationSensorFlagEnum {
        'FORWARD_DYNAMICS_FORCES',
        'CONSTRAINT_SOLVER_FORCES',
        'WORLD_FRAME'
    }
    ...
    enum PxTriangleMeshAnalysisResultEnum {
        ...
        'CONTAINS_ACUTE_ANGLED_TRIANGLES',
        'EDGE_SHARED_BY_MORE_THAN_TWO_TRIANGLES',
        'CONTAINS_DUPLICATE_POINTS',
        'CONTAINS_INVALID_POINTS',
        'REQUIRES_32BIT_INDEX_BUFFER',
    ...
    enum PxVehicleCommandNonLinearResponseParamsEnum {
        'MAX_NB_COMMAND_VALUES'
    }
    enum PxVehicleCommandValueResponseTableEnum {
        'MAX_NB_SPEED_RESPONSES'
    }
    ...
    enum PxVehiclePhysXConstraintLimitsEnum {
        'NB_DOFS_PER_PXCONSTRAINT',
        'NB_DOFS_PER_WHEEL',
        'NB_WHEELS_PER_PXCONSTRAINT',
        'NB_CONSTRAINTS_PER_VEHICLE'
    }
